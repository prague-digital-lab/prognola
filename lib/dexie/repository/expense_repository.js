...
function createExpenseObject(expense) {
  return {
    ...
    received_at: expense.received_at ? DateTime.fromISO(expense.received_at).toJSDate() : null,
...
export { getExpensesByPaidAt, updateExpenseFromLocalObject, getExpense, addExpense, updateExpense, getExpensesByOrganisation };
