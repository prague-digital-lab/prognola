  ...
  <div class="text-sm py-1 rounded text-gray-700 mb-4 relative hover:bg-gray-100">
    ...
    <div v-if="select_expanded"
      ...
      <div class="mb-2" @click="setStatus('plan')">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-5 inline-block text-orange-400 me-2">
      ...
      <div class="mb-2" @click="setStatus('pending')">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-5 inline-block text-yellow-500 me-2">
      ...
      <div @click="setStatus('paid')">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-5 inline-block text-indigo-700 me-2">
