...
export default {
  ...
  mounted() {
    this.received_at = DateTime.fromISO(this.expense.received_at).toFormat('yyyy-MM-dd')
  },
  ...
  <div class="relative">
    ...
    <Transition>
      <div v-if="expanded"
        ...
        <input class="rounded w-full mb-2" type="date" autofocus v-on:blur="updateDate" v-model="received_at">
