<template>
  <div class="px-3 py-2 hover:bg-slate-50 flex justify-between items-center" @click="navigateToExpense">
    ...
    <div class="text-sm text-slate-600 font-light flex items-center">
      <div v-if="expense.organisation" class="rounded-[20px] hover:bg-slate-100 hover:border-gray-300 cursor-pointer border border-gray-200 px-3 py-1 flex items-center"
